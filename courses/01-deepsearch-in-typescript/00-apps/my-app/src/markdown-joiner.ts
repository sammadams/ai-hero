...
/**
 * A class that buffers markdown elements to prevent janky streaming
 * of incomplete markdown syntax like **, `, [, etc.
 */
...
/**
 * Transform function that improves markdown streaming by buffering
 * incomplete markdown elements until they are complete
 */
